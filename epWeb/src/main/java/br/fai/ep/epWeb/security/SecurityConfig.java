...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(final HttpSecurity http) throws Exception {
        http
                ...
                // User
                .antMatchers("/user/profile/**").hasRole(ROLE_NAME.USER)
                .antMatchers("/user/edit/**").hasRole(ROLE_NAME.USER)
                .antMatchers("/user/update-user-data").hasRole(ROLE_NAME.USER)

                // Partner
                .antMatchers("/partner/list").permitAll()
                .antMatchers("/partner/detail/**").permitAll()
                .antMatchers("/partner/register/**").hasRole(ROLE_NAME.USER)
                .antMatchers("/partner/request-register").hasRole(ROLE_NAME.USER)
                .antMatchers("/partner/my-data-as-partner/**").hasRole(ROLE_NAME.PARTNER)
                .antMatchers("/partner/edit-my-data-as-partner/**").hasRole(ROLE_NAME.PARTNER)
                .antMatchers("/partner/update-my-data-as-partner").hasRole(ROLE_NAME.PARTNER)
                .antMatchers("/partner/delete-my-data-as-partner/**").hasRole(ROLE_NAME.PARTNER)
                .antMatchers("/partner/new-registration-requestl/**").hasRole(ROLE_NAME.PARTNER)
                ...
                .antMatchers("/news/create-new-news/**").hasRole(ROLE_NAME.USER)
                .antMatchers("/news/request-news-publication").hasRole(ROLE_NAME.USER)
                .antMatchers("/news/user-news-list/**").hasRole(ROLE_NAME.AUTHOR)
                .antMatchers("/news/user-news-detail/**").hasRole(ROLE_NAME.AUTHOR)
                .antMatchers("/news/delete-user-news/**").hasRole(ROLE_NAME.AUTHOR)
                .antMatchers("/news/new-publication-request/**").hasRole(ROLE_NAME.AUTHOR)
                .antMatchers("/news/user-news-edit/**").hasRole(ROLE_NAME.AUTHOR)
                .antMatchers("/news/update-user-news/**").hasRole(ROLE_NAME.AUTHOR)
